...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IFinTrackDbContext>(sp => sp.GetRequiredService<FinTrackDbContext>());
        ...
        var secret = configuration["Jwt:Secret"] ?? "replace-with-a-secure-secret-that-is-long-enough-123456";
        var issuer = configuration["Jwt:Issuer"] ?? "FinTrack";
        var audience = configuration["Jwt:Audience"] ?? "FinTrackMobile";
